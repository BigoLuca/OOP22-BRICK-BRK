...
public class GameView extends ViewImpl {
    ...
    public void render() {
        ...
        Platform.runLater(() -> {
            ...
            List<Brick> b = ((LevelControllerImpl) this.getController()).getBricks();
            for (Brick item : b) {
            ...
            Bar bar = ((LevelControllerImpl) this.getController()).getBar();
            Ball ball = ((LevelControllerImpl) this.getController()).getBall();
